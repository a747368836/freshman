...
public class BBEBean {
    ...
    /* *//**
     * array : [{"content":"仅供测试：中心食堂的描述\n换行测试：第二行内容\n换行测试：第三行内容","id":1,"name":"中心食堂","picture":["url3","url4"]},{"content":"仅供测试：延生的描述\n换行测试：第二行内容\n换行测试：第三行内容","id":2,"name":"延生","picture":["url5","url6"]},{"content":"仅供测试：千喜鹤的描述\n换行测试：第二行内容\n换行测试：第三行内容","id":3,"name":"千喜鹤","picture":["url7","url8"]},{"content":"仅供测试：大学城食堂的描述\n换行测试：第二行内容\n换行测试：第三行内容","id":4,"name":"大学城食堂","picture":["url9","url10"]},{"content":"仅供测试：大西北食堂的描述\n换行测试：第二行内容\n换行测试：第三行内容","id":5,"name":"大西北食堂","picture":["url11","url12"]},{"content":"仅供测试：红高粱的描述\n换行测试：第二行内容\n换行测试：第三行内容","id":6,"name":"红高粱","picture":["url13","url14"]}]
     * index : 学生食堂
     *//*
